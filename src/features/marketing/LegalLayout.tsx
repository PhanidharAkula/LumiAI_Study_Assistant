...
const PROSE = [
  ...
  "[&_ul]:mt-1.5 [&_ul]:mb-4 [&_ul]:ml-5.5 [&_ul]:leading-[1.75] [&_ul]:text-[15px]",
  "[&_li]:mb-2",
...
const LegalLayout = ({ children }: { children: ReactNode }) => {
  ...
  return (
    <div className="flex min-h-dvh w-full justify-center px-5 py-5 max-[480px]:px-3.75">
      <div className="w-full max-w-190 cursor-default max-[480px]:px-1">
        <BackButton
          className="mb-5"
