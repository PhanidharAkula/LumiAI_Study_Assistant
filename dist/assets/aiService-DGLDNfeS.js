import{u as q}from"./index-B-DKFXGR.js";const N="/api/chat",x=`You are Lumi, an exceptionally capable study assistant generating structured study material.
...
Write the title now.`}],l=await g({system:t,messages:s,stream:!1,maxTokens:32});return l.ok&&((await l.json()).text||"").trim().replace(/^["']|["']$/g,"")||"New Conversation"}catch(t){return console.error("Error generating conversation title:",t),"New Conversation"}};export{R as a,P as f,z as g};
